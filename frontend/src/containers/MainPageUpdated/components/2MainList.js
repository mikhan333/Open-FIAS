                            ...
                            <div className="row justify-content-center">
                                <div className="col-md-12 text-center">
                                    ...
                                    <div className="watch-video pt-4 mt-1 navigation-menu">
                                        <button onClick={ () => props.history.push('/add_point') } className="btn btn-outline-custom btn-rounded mt-2">Начать</button>
                                        <a href="#help" className="btn btn-custom btn-rounded mt-2">Что делать?</a>
                                    </div>
                                </div>
                            </div>
                        </div>
