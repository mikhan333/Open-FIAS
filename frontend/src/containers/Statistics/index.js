    ...
    render() {
        ...
        return (
            <>
                ...
                <div className="row">
                    <div class="col-lg-6 mt-3" onClick={() => this.handleOpen('usersTop')} style={{ cursor: "pointer", }}>
                        <div class="service-box clearfix p-4">
                            <div class="service-icon service-left text-custom"><i class="mbri-growing-chart"></i></div>
